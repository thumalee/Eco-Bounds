                    ...
                    if (dataSnapshot.exists())
                    {
                        ...
                        if (dataSnapshot.hasChild("Security Questions"))
                        {
                            ...
                            else
                            {
                                ...
                                newPassword.setHint("New Paswword");
                        ...
                        {
                            Toast.makeText(ResetPassword.this,"Security questions are not set",Toast.LENGTH_SHORT).show();
                        }
                    }
                    else
                    {
                        Toast.makeText(ResetPassword.this,"Phone number does not exist",Toast.LENGTH_SHORT).show();
                    }
                }
